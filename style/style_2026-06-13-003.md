...
- Markers are SVG circles, each with a `<title>` (native hover tooltip, no JS):
  ...
  - Warehouse: fill #b8b8b8 (warm grey), r 5, stroke #1a2b3c, stroke-width 1.5 — 19 US locations. Changed from #7aabb8 to #b8b8b8 (PR #27) to improve visual distinction from the office marker (teal #4A9E8E) on the map
