...
## Layout
- Full width — no max-width constraint on any section
- Section backgrounds extend edge to edge
- Section padding: 40px top/bottom, 28px left/right
- Content sits within section padding — no inner container
...
## Imagery
- [PLACEHOLDER — to be decided as pages are built]
- Tabler outline icons used throughout v1 as placeholder
